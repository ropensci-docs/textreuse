...
[research](https://doi.org/10.1093/ahr/123.1.132) into the propagation
of legal codes of civil procedure in the nineteenth-century United
States.
...
function applies a comparison function (in this case,
[`jaccard_similarity()`](https://docs.ropensci.org/textreuse/reference/similarity-functions.md))
to every pair of documents. The result is a matrix of scores. As we
would expect, some documents are similar and others are not.
